...
const Navbar = () => {
  ...
  // Utilisez useAuth pour gérer l'état de connexion et le rôle de l'utilisateur
  ...
  const drawerContent = (
    <List>
      ...
      {isLoggedIn ? (
        <>
          {/* Afficher Profile et Logout si l'utilisateur est connecté */}
          <ListItem disablePadding>
            <ListItemButton
              component={Link}
              to="/profile"
          ...
          {/* Afficher un lien vers le tableau de bord pour les administrateurs */}
          {user?.role === "admin" && (
            <ListItem disablePadding>
              <ListItemButton
                component={Link}
